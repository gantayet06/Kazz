...
import Logo from '../../assets/images/WhatsApp Image 2024-05-06 at 02.07.31_6dd9a162.jpg';
...
const Header = (props) => {
    ...
    useEffect(() => {
        getCountry('https://countriesnow.space/api/v0.1/countries/');//make changes here for location
    }, []);
                    ...
                    <div className='container-fluid'>
                        <div className='row align-items-center'>
                            <div className='col-sm-2 part1 d-flex align-items-center'>
                                <Link to="/"><img src={Logo} className='logo' style={{height:"120px",width:"120px",marginLeft:"50px",imageRendering:"pixelated",objectFit:"cover",borderRadius:"500px",display:"flex"}}/></Link>
                                {
                                    windowWidth < 992 &&
                                        ...
                                        <ul className='list list-inline mb-0 headerTabs'>
...

                                            {
                                                context.isLogin === "true" ?
                                                    ...
                                                    <li className='list-inline-item'>
                                                        <Link to={'/signIn'}>
                                                            <Button type="button" className="btn btn-g">Sign In</Button>
                                                        </Link>
                                                    </li>
